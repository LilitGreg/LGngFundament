      ...
      <div>
        ...
        <div class="row">
          <div class="col-md-5" *ngFor ="let event of events">
            ...
            (click) = "handleTumbnailClick(event.name)"
...
//Template reference variables allow you to specify a variable name
// that points to a component and then you can access any public properties
// or methods on that component using that variable.
